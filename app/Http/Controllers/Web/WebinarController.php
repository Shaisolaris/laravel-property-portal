...
class WebinarController extends Controller
{
    ...
    public function courseDetails($slug, $justReturnData = false)
    {
        $user = null;
        ...
        return view('web.public_academy.courses_details', $data);
    }

    public function academyCoursesDetails($slug, $justReturnData = false)
    {
        $user = null;
        ...
        return view('web.public_academy.my_courses_details', $data);
    }
}
