...
class UserSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $admin = User::updateOrCreate(['email' => 'admin@example.com'], $baseData);

        $baseData['email'] = 'superAdmin@example.com';
        $baseData['first_name'] = 'Super';
        $baseData['last_name'] = 'Admin';
        $superAdmin = User::updateOrCreate(['email' => 'superAdmin@example.com'], $baseData);

        /* SCHOOL */

        $baseData['email'] = 'organizerSchool@example.com';
        $baseData['first_name'] = 'Organizer';
        $baseData['last_name'] = 'School';
        $organizerSchool = User::updateOrCreate(['email' => 'organizerSchool@example.com'], $baseData);

        $baseData['email'] = 'instructorSchool@example.com';
        $baseData['first_name'] = 'Instructor';
        $baseData['last_name'] = 'School';
        $instructorSchool = User::updateOrCreate(['email' => 'instructorSchool@example.com'], $baseData);

        $baseData['email'] = 'studentSchool@example.com';
        $baseData['first_name'] = 'Student';
        $baseData['last_name'] = 'School';
        $studentSchool = User::updateOrCreate(['email' => 'studentSchool@example.com'], $baseData);

        /**/


        /* ACADEMY */
        $baseData['email'] = 'organizerAcademy@example.com';
        $baseData['first_name'] = 'Organizer';
        $baseData['last_name'] = 'Academy';
        $organizerAcademy = User::updateOrCreate(['email' => 'organizerAcademy@example.com'], $baseData);

        $baseData['email'] = 'instructorAcademy@example.com';
        $baseData['first_name'] = 'Instructor';
        $baseData['last_name'] = 'Academy';
        $instructorAcademy = User::updateOrCreate(['email' => 'instructorAcademy@example.com'], $baseData);

        $baseData['email'] = 'studentAcademy@example.com';
        $baseData['first_name'] = 'Student';
        $baseData['last_name'] = 'Academy';
        $studentAcademy = User::updateOrCreate(['email' => 'studentAcademy@example.com'], $baseData);
        /**/
