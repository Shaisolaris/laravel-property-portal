...
<div class="CourseListWrapper">
    ...
    <div class="courseSection">
        <div class="container px-lg-0">
            ...
            <div class="row">
                <div class="allCourseSideBar courseListSideBar" id="sidebar">
                    <nav>
                        <div
                                        ...
                                        <div class="checkList">
                                            <div class="checkWrapper">
                                                <div class="form-check form-check-inline mr-0">
                                                    ...
                                                    <label class="form-check-label" for="allCategory"
                                                    >Math: high school & college</label
                                                    >
                                                </div>
                                                <p class="cousreItem">5</p>
                                            </div>
                ...
                <div class="coursesCardList">
                    ...
                    <div class="cardListWrap">
                        <div class="card courseListCard">
                            ...
                            <div class="card-body">
                                <div class="cardData">
                                    <a href="{{ url('/design/class-details') }}">
                                        <h3 class="card-title">
