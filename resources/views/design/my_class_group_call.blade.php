  ...
  <body>
    <div class="navbarWraper">
      ...
      <div class="topBar myCourseAssignment">
        <div class="container">
          <div class="row align-items-center px-2 px-sm-0">
      ...
      <div class="container">
        <div class="row">
            ...
            <div class="courses_Detail_Wrapper">
              <div class="d-flex flex-wrap">
                <div class="col-lg-4 p-0">
                  <img
                    class="windows_Wrapper"
                    src="img/dashboard-school/one.svg"
                    alt=""
                  />
                </div>
                <div class="col-lg-4 p-0">
                  <img
                    class="windows_Wrapper"
                    src="img/dashboard-school/two.svg"
                    alt=""
                  />
                </div>
                <div class="col-lg-4 p-0">
                  <img
                    class="windows_Wrapper"
                    src="img/dashboard-school/three.svg"
                    alt=""
                  />
                </div>
                <div class="col-lg-4 p-0">
                  <img
                    class="windows_Wrapper"
                    src="img/dashboard-school/four.svg"
                    alt=""
                  />
                </div>
                <div class="col-lg-4 p-0">
                  <img
                    class="windows_Wrapper"
                    src="img/dashboard-school/five.svg"
                    alt=""
                  />
                </div>
                <div class="col-lg-4 p-0">
                  <img
                    class="windows_Wrapper"
                    src="img/dashboard-school/six.svg"
                    alt=""
                  />
                </div>
                <div class="col-lg-4 p-0">
                  <img
                    class="windows_Wrapper"
                    src="img/dashboard-school/seven.svg"
                    alt=""
                  />
                </div>
                <div class="col-lg-4 p-0">
                  <img
                    class="windows_Wrapper"
                    src="img/dashboard-school/eight.svg"
                    alt=""
                  />
                </div>
                <div class="col-lg-4 p-0">
                  <img
                    class="windows_Wrapper"
                    src="img/dashboard-school/nine.svg"
                    alt=""
                  />
                </div>
              </div>
              <div class="window_Btns">
                <div class="image_Div">
                  <img src="img/dashboard-school/arrows-angle-expand.svg" />
                </div>
                <div class="image_Div">
                  <img src="img/dashboard-school/mic-fill.svg" />
                </div>
                <div class="image_Div">
                  <img src="img/dashboard-school/camera-video-off.svg" />
                </div>
              </div>
            </div>
            <!-- Image for Courses -->
          ...
          <div class="col-lg-4">
            ...
            <!-- more sessions -->
            <!-- right Tabbing -->
            <div class="lesson_tabbing_Wrapper">
                ...
                <div class="accordion" id="sidebardropdown">
                  ...
                  <div class="courseTableContent">
                    ...
                    >
                      ...
                      <img src="img/courseDetail/Arrowdown.svg" alt="inoura" />
                    </button>
                    ...
                    >
                      <div class="accordionBody">
                        ...
                        >
                          <div
                            class="lecturesTitle d-flex align-items-center flex-column"
                          >
                            <div class="form-check form-check-inline mr-0">
                              ...
                              <label class="form-check-label" for="allCategory"
                                >1.1 Introduction</label
                              >
                            </div>
                            <div
                              class="lectureDuration d-flex align-items-center justify-content-start"
                            >
                              <img
                        ...
                        >
                          ...
                          >
                            <div class="form-check form-check-inline mr-0">
                              ...
                              <label class="form-check-label" for="allCategory1"
                                >1.2. Demo</label
                              >
                            </div>
                            <div
                    ...
                    <!-- Accordion Three ends -->

                    <!-- Accordion Four starts -->
                    <button
                      class="btn accordionBtn d-flex justify-content-between"
                      type="button"
                      data-toggle="collapse"
