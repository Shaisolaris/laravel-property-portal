...
@section('content')
    <x-table type="rounded-tr-border" :head-items="['Student name', 'Deadline', 'Score', 'Status', 'Action']">
        <x-slot:body>
            <tr>
                ...
                <td>10/10</td>
                <td>
                    <x-badge key="active" variable="thistle" />
                </td>
            ...
            <tr>
                ...
                <td>10/10</td>
                <td>
                    <x-badge key="not-accepted" variable="light-steel-blue" />
                </td>
                <td>View Assignment</td>
            </tr>
            <tr>
                ...
                <td>10/10</td>
                <td>
                    <x-badge key="accepted" variable="crimson" />
                </td>
                <td>View Assignment</td>
            </tr>
        </x-slot:body>
    ...
    <x-avatar-group
        plus-amount="12"
        :avatars="[URL::asset('build/images/users/avatar-2.jpg'),URL::asset('build/images/users/avatar-3.jpg'),URL::asset('build/images/users/avatar-4.jpg')]"
    />
