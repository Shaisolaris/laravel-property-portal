    ...
    <x-card.base>
        <form
            ...
            <div class="form-field mb-3">
                <x-form.date-time-picker name="duration" label="Duration (hh/mm/ss)*" id="duration"/>
            </div>
            <div class="form-field mb-3">
{{--                <x-form.multiselect name="tags" label="Title" id="title" placeholder="Type tag name and press enter"/>--}}
            </div>
            <div class="form-field mb-3">
                <x-form.select  name="category" id="category" label="Category*" :options="[['English', 'English'], ['French', 'French'], ['Spanish', 'Spanish']]" placeholder="Select a category"/>
            </div>
            <div>
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <x-card.base>
                            ...
                            <x-form.input reverseInputBox="true" type="checkbox" name="makeup_artistry" label="Makeup Artistry"/>
                            ...
                            <x-form.input reverseInputBox="true"reverseInputBox="true" type="checkbox" name="fashion" label="Fashion"/>
