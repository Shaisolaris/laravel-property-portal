                                                ...
                                                <div class="d-flex justify-content-between align-items-center flex-column flex-md-row">
                                                    <div class="d-flex tagWrapper">
                                                        <div class="tags enrollment d-flex align-items-center">
                                                            ...
                                                            <div>{{ $user->rates() }} ({{ $user->reviewsCount() }} Reviews)</div>
                                                        </div>
                                                        ...
                                                        <div class="tags duration d-flex align-items-center">
                                                            ...
                                                            <div class="time">{{ count($user->webinars) }} Courses</div>
                                                        </div>
                                                    </div>
                            ...
                            <div class="courseOverview">
                                    ...
                                    <ul class="nav nav-pills" id="pills-tab" role="tablist">
                                        <li class="nav-item">
                                            ...
                                            >
                                                ...
                                                >
                                                    <path
                                                        d="M6.79 5.59294C6.71524 5.5397 6.62726 5.50808 6.53572 5.50152C6.44418 5.49497 6.35259 5.51373 6.27101 5.55576C6.18942 5.5978 6.12098 5.66147 6.07317 5.73982C6.02537 5.81817 6.00006 5.90816 6 5.99994V10.9999C6.00006 11.0917 6.02537 11.1817 6.07317 11.2601C6.12098 11.3384 6.18942 11.4021 6.27101 11.4441C6.35259 11.4861 6.44418 11.5049 6.53572 11.4984C6.62726 11.4918 6.71524 11.4602 6.79 11.4069L10.29 8.90694C10.3548 8.86068 10.4076 8.79962 10.4441 8.72883C10.4805 8.65804 10.4996 8.57956 10.4996 8.49994C10.4996 8.42031 10.4805 8.34184 10.4441 8.27104C10.4076 8.20025 10.3548 8.13919 10.29 8.09294L6.79 5.59294Z"
                                                        fill="black"
                                                    />
                                                    <path
                                                        d="M0 4.5C0 3.96957 0.210714 3.46086 0.585786 3.08579C0.960859 2.71071 1.46957 2.5 2 2.5H14C14.5304 2.5 15.0391 2.71071 15.4142 3.08579C15.7893 3.46086 16 3.96957 16 4.5V12.5C16 13.0304 15.7893 13.5391 15.4142 13.9142C15.0391 14.2893 14.5304 14.5 14 14.5H2C1.46957 14.5 0.960859 14.2893 0.585786 13.9142C0.210714 13.5391 0 13.0304 0 12.5V4.5ZM15 4.5C15 4.23478 14.8946 3.98043 14.7071 3.79289C14.5196 3.60536 14.2652 3.5 14 3.5H2C1.73478 3.5 1.48043 3.60536 1.29289 3.79289C1.10536 3.98043 1 4.23478 1 4.5V12.5C1 12.7652 1.10536 13.0196 1.29289 13.2071C1.48043 13.3946 1.73478 13.5 2 13.5H14C14.2652 13.5 14.5196 13.3946 14.7071 13.2071C14.8946 13.0196 15 12.7652 15 12.5V4.5Z"
                                                        fill="black"
                                                    />
                                                </svg>
                                                My Courses</a
                                        ...
                                        <li class="nav-item">
                                            <a
                                                class="nav-link"
                                                id="pills-mySessions-tab"
                                                data-toggle="pill"
                                                href="#pills-mySessions"
                                                role="tab"
                                                aria-controls="pills-mySessions"
                                                aria-selected="false"
                                            >
                                                <svg
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    fill="none"
                                                >
                                                    <g clip-path="url(#clip0_1025_7317)">
                                                        <path
                                                            d="M8 9.55005C8.66304 9.55005 9.29893 9.28666 9.76777 8.81782C10.2366 8.34897 10.5 7.71309 10.5 7.05005C10.5 6.38701 10.2366 5.75112 9.76777 5.28228C9.29893 4.81344 8.66304 4.55005 8 4.55005C7.33696 4.55005 6.70107 4.81344 6.23223 5.28228C5.76339 5.75112 5.5 6.38701 5.5 7.05005C5.5 7.71309 5.76339 8.34897 6.23223 8.81782C6.70107 9.28666 7.33696 9.55005 8 9.55005Z"
                                                            fill="#676A6C"
                                                        />
                                                        <path
                                ...
                                <div class="tabContentWrapper">
                                    <div class="tab-content" id="pills-tabContent">
                                        <div class="tab-pane fade show active" id="pills-myCourses" role="tabpanel" aria-labelledby="pills-myCourses-tab">
                                            <div class="myCoursesMentor">
                                                @foreach($webinars as $webinar)
                                                    <div class="card courseCard">
                                                        <div class="cardImgWrap">
                                                            ...
                                                            <img src="{{ $webinar->getImage() }}" alt="{{ $webinar->title }}" class="card-img-top cardImg"/>
                                                        </div>
                                                        <div class="card-body">
                                                            <div class="cardData">
                                                                ...
                                                                <p class="card-text">{{ (strip_tags($webinar->getDescriptionAttribute())) }}</p>
                                                            </div>
                                        ...
                                        <div
                                            ...
                                            id="pills-mySessions"
                                            role="tabpanel"
                                            aria-labelledby="pills-mySessions-tab"
                                        >
                                            <div class="mySessionsMentor">
                                                <div class="card courseCard">
                                                    <div class="cardImgWrap">
                                                        ...
                                                        <img
                                                            src="/design/img/dashboard/img2.png"
                                                            alt="inoura"
                                                    ...
                                                    <div class="card-body">
                                                        <div class="cardData">
                                                            ...
                                                            <a href="{{ url('/design/my-mentor-session') }}">
                                                                <h3 class="card-title">
                                                            ...
                                                            <p class="card-text">
                                                                ...
                                                                experts and thought leaders will guide you
                                                                in acquiring new expertise, expanding your
                                                            ...
                                                            <div class="instructorWrap">
                                                                <div class="instructorImages">
                                                                    <img
                                                                        src="/design/img/dashboard/1.svg"
                                                                        alt="inoura"
                                                                        class="instructorProfile"
                                                                    />
                                                                    <img
                                                                        src="/design/img/dashboard/2.svg"
                                                                        alt="inoura"
                                                                        class="instructorProfile"
                                                                    />
                                                                    <img
                                                                        src="/design/img/dashboard/3.svg"
                                                                        alt="inoura"
                                                                        class="instructorProfile"
                                                                    />
                                                                    <div
                                                ...
                                                <div class="card courseCard">
                                                    <div class="cardImgWrap">
                                                        ...
                                                        <img
                                                            src="/design/img/dashboard/img.png"
                                                            alt="inoura"
                                                            class="card-img-top cardImg"
                                                        />
                                                    </div>
