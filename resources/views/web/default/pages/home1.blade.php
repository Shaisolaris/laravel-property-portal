            ...
            <div class="counter-card-wrapper">
                <div class="row">
                    <div class="col-md-3 counter-card" >
                        <h3><span class="counter">{{ $homeDefaultStatistics['studentsCount'] }}</span>+</h3>
                        <p>happy <br> students</p>
                    </div> 
                    <div class="col-md-3 counter-card">
                        <h3><span class="counter">{{ $homeDefaultStatistics['skillfulTeachersCount'] }}</span>+</h3>
                        <p>experienced<br> instructors</p>
                    </div>
                    <div class="col-md-3 counter-card">
                        <h3><span class="counter">{{ $homeDefaultStatistics['liveClassCount'] }}</span>+</h3>
                        <p>Live<br> Classes</p>
                    </div>
                    <div class="col-md-3 counter-card">
                        <h3><span class="counter">{{ $homeDefaultStatistics['offlineCourseCount'] }}</span>+</h3>
                        ...
                        <div class="row upcoming-row">
                            <div class="col-md-7 upcoming-col">
                                <div class="upcoming-text">
                                    ...
                                    <h2>{{ clean($upcomingCourse->title,'title') }}</h2>
