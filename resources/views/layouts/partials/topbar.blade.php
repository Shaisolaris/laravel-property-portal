...
{{--                <div class="dropdown">--}}
{{--                    <button--}}
{{--                        class="dropdown-toggle bg-transparent border-0 text-dim-gray"--}}
{{--                        type="button"--}}
...
{{--            </div>--}}
{{--        </div>--}}
{{--        <div class="d-none d-xl-flex navbar-header">--}}
{{--            <div class="d-flex">--}}
{{--                <a href="" class="text-black me-2">Academy of Inoura</a>--}}
{{--                <a href="" class="text-black">School of Inoura</a>--}}
{{--            </div>--}}
...
{{--                            class="dropdown-item"--}}
{{--                            href="pages-profile"--}}
{{--                        ><i class="mdi mdi-wallet text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Balance : <b>$5971.67</b></span></a>--}}
{{--                        <a--}}
{{--                            class="dropdown-item"--}}
...
{{--                        ><i class="mdi mdi-lock text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Lock screen</span></a>--}}
{{--                        <a--}}
{{--                            class="dropdown-item "--}}
