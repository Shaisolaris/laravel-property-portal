...
watch(
    ...
    (flashMessage) => {
        if (!isEmpty(flashMessage) && flashMessage.type !== undefined) {
            baseToast('backend', flashMessage.type, flashMessage.text, flashMessage.options);
        }
    }
);
        ...
        <div id="layout-wrapper">
            ...
            <div>
                <div class="app-menu navbar-menu">
                    ...
                    <div class="d-flex align-items-center pxc-20 pbc-10 avatar-block">
                        <div class="me-4">
                            <Avatar
                                :path="$page.props.auth?.avatar"
                                :name="$page.props.auth?.full_name"
                                rounded="circle"
                                size="lg"
                            />
                        </div>
                        <div class="d-block d-lg-none d-xl-block text-start">
                            ...
                            <div class="sidebar-name-block fs-3 fw-medium">{{ $page.props.auth?.full_name }}</div>
                        </div>
                    </div>
                        ...
                        <slot name="breadcrumbs">
                            <Breadcrumbs :title="title" :breadcrumb="breadcrumb">
                                <template #breadcrumbs-right>
                                    <div v-if="showBreadcrumbsRightSide">
