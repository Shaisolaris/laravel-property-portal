...
// @ts-ignore
import { BToastPlugin } from 'bootstrap-vue-next/src/components/BToast/plugin.ts'
import type { BootstrapVueOptions } from 'bootstrap-vue-next/src/types';
import './styles/styles.scss'

import * as Components from 'bootstrap-vue-next/src/components'
import * as Directives from 'bootstrap-vue-next/src/directives'
import type { ComponentType, DirectiveType } from 'bootstrap-vue-next/src/types/BootstrapVueOptions'
import parseActiveImports from 'bootstrap-vue-next/src/utils/parseActiveImports'
...
export * from 'bootstrap-vue-next/src/components'
export * as Components from 'bootstrap-vue-next/src/components'
export * from 'bootstrap-vue-next/src/directives'
export * as Directives from 'bootstrap-vue-next/src/directives'
export * from 'bootstrap-vue-next/src/composables/exports'
export * as Composables from 'bootstrap-vue-next/src/composables/exports'
export * from 'bootstrap-vue-next/src/utils/exports'
export * as Utils from 'bootstrap-vue-next/src/utils/exports'
export * from 'bootstrap-vue-next/src/types/exports'
export * as Types from 'bootstrap-vue-next/src/types/exports'
// @ts-ignore
export { useToast } from 'bootstrap-vue-next/src/components/BToast'
