...
//Class Subject
        ...
        'subjects.*.teachers' => 'instructor(s)',
        'subjects.*.image' => 'image',
        'subjects.*.name' => 'name',

//Class Subject Schedule
        'events.*.subject' => 'subject',
        'events.*.lesson_link' => 'lesson link',
        'events.*.event_date' => 'event date',
        'events.*.user_id' => 'instructor',
        'events.*.event_end_time' => 'event end time',
        'events.*.event_start_time' => 'event start time',
