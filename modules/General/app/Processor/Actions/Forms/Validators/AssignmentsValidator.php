...
class AssignmentsValidator implements Arrayable
{
    public function toArray(): array
    {
        return [
            ...
            'assignments.*.materials' => ['required','min:1'],
            'assignments.*.materials.*.video' => ['required','string','url:http,https'],
...
//            'assignments.*.materials.*.video' => [File::types(BasicInformationValidator::VIDEO_TYPES)->max(BasicInformationValidator::VIDEOS_MAX_SIZE)],
        ];
    }
