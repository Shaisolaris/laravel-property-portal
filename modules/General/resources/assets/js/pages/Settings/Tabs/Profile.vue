...
const formProfile = useForm({
    ...
    birth_at: user.value?.birth_at ?? null,
...
const submitUpload = () => {
    formImage.post(route('upload.profile-photo'), {
        onSuccess: () => {
            setTimeout(() => {
                router.visit(route('general.settings.index'));
            }, 50);
        },
    });
}
                    ...
                    <Collapse :show-button="false" id="collapse-birth-edit" class="multi-collapse">
                        <template #body>
                            <b-row class="align-items-center">
                                ...
                                <b-col cols="6">
                                    <DateTimePicker v-model="formProfile.birth_at" placeholder="select-date-of-birth" />
                                </b-col>
                                <b-col cols="3" class="text-end">
                                    <div class="d-flex justify-content-end gap-2">
                                        <BaseButton
