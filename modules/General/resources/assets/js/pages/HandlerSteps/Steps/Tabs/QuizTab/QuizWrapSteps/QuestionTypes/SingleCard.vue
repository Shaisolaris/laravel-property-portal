...
<template>
    <BaseInput
        ...
        :error="form.errors[`quizzes.${quizIndex}.questions.single.${formElementIndex}.title`]"
    ...
    <div class="pt-4">
        <b-row class="gy-3">
            <b-col v-for="(answer, answerIndex) in formElement.answers" cols="12">
                <b-row class="g-3">
                    <b-col cols="12" sm="8" md="8" lg="9">
                        <div class="d-flex align-items-center flex-grow-1 gap-3">
                            <div class="flex-shrink-0 fs-16 fw-medium me-2">{{ letters[answerIndex] }}</div>
                            <div class="flex-grow-1">
                                <BaseInput
                                    v-model="answer.answer"
                                    :error="form.errors[`questions.single.${quizIndex}.answers.${answerIndex}.answer`]"
                    ...
                    <b-col cols="12" sm="4" md="4" lg="3">
                        <div class="d-flex text-end justify-content-end w-100 wc-md-84 gap-2">
                            ...
                            <BaseButton class="bg-white border-gainsboro" @click="deleteAnswer(quizIndex)">
                                <template #text>
                ...
                <div class="text-end">
                    <ErrorMessage :error="form.errors[`questions.single.${quizIndex}.answers.${answerIndex}.is_correct`]" />
                </div>
            </b-col>
        </b-row>
        ...
        <ErrorMessage :error="form.errors[`quizzes.${quizIndex}.questions.single.${formElementIndex}.answers`]" />
    </div>
</template>
