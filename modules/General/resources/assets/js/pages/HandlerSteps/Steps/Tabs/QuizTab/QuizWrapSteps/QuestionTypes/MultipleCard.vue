...
<template>
    <BaseInput
        ...
        :error="form.errors[`quizzes.${quizIndex}.questions.multiple.${formElementIndex}.title`]"
    ...
    <div class="pt-4">
                        ...
                        <div class="d-flex align-items-center flex-grow-1 gap-3">
                            ...
                            <div class="flex-grow-1">
                                <BaseInput
                                    ...
                                    :error="form.errors[`questions.multiple.${quizIndex}.answers.${answerIndex}.answer`]"
        ...
        <ErrorMessage :error="form.errors[`quizzes.${quizIndex}.questions.multiple.${formElementIndex}.answers`]" />
    </div>
</template>
