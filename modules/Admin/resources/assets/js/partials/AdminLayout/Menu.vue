...
<template>
    <b-container fluid>
        ...
        <ul class="navbar-nav h-100" id="navbar-nav">
            <li class="menu-title">
                <span data-key="t-menu"> {{ $t("admin.menu.menu") }}</span>
            </li>
            <template v-for="(navigation, index) in $page.props.navigations">

                <pre>{{ JSON.stringify(navigation, null, 4) }}</pre>
                <li class="menu-title" v-if="navigation.isTitle">
                    <span data-key="t-menu"> {{ $t(`admin.menu.${navigation.tKey}`) }}</span>
                </li>

                <li class="nav-item" v-else-if="!navigation.items">
                    <Link
                    ...
                    <a class="nav-link menu-link">
                        <i :class="['ri-home-8-line', 'fs-20']"></i>
                        <span data-key="t-dashboards"> {{ $t("admin.menu.dashboard") }}</span>
                    </a>
                </li>
                <!--                <li v-if="navigation.length > 0" class="menu-title">-->
                <!--                    <span :data-key="`t-${index}`"> {{ $t(`t-${index}`) }}</span>-->
                <!--                </li>-->
        ...
        <ul class="navbar-nav h-100" id="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link menu-link active" role="button">
                    <i :class="['ri-home-8-line', 'fs-20']"></i>
                    <span data-key="t-dashboards"> {{ $t("admin.menu.dashboard") }}</span>
                </a>
            </li>
            ...
            <!--            </BCollapse>-->
            <li class="nav-item">
                <a class="nav-link menu-link" v-b-toggle="'collapse-1'">
                    <HomeIcon width="24" height="24"/>
                    <span data-key="t-dashboards"> {{ $t("t-dashboards") }}</span>
                </a>
                <BCollapse id="collapse-1" class=" menu-dropdown">
                ...
                <div class="collapse menu-dropdown mega-dropdown-menu" id="sidebarUI">
                    <BRow>
                        <BCol col lg="4">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <Link href="/ui/alerts" class="nav-link" data-key="t-alerts">{{
                                            $t("t-alerts")
                                        }}
                                    </Link>
                                </li>
                                <li class="nav-item">
                                    <Link href="/ui/badges" class="nav-link" data-key="t-badges">{{
                                            $t("t-badges")
                                        }}
                                    </Link>
                                </li>
                                ...
                                <li class="nav-item">
                                    <Link href="/ui/colors" class="nav-link" data-key="t-colors">{{
                                            $t("t-colors")
                                        }}
                                    </Link>
                                </li>
                                <li class="nav-item">
                                    <Link href="/ui/cards" class="nav-link" data-key="t-cards">{{
                                            $t("t-cards")
                                        }}
                                    </Link>
                                </li>
                                <li class="nav-item">
                                    <Link href="/ui/carousel" class="nav-link" data-key="t-carousel">{{
                                            $t("t-carousel")
                                        }}
                                    </Link>
                                </li>
                        ...
                        <BCol col lg="4">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <Link href="/ui/images" class="nav-link" data-key="t-images">{{
                                            $t("t-images")
                                        }}
                                    </Link>
                                </li>
                                ...
                                <li class="nav-item">
                                    <Link href="/ui/modals" class="nav-link" data-key="t-modals">{{
                                            $t("t-modals")
                                        }}
                                    </Link>
                                </li>
                                ...
                                <li class="nav-item">
                                    <Link href="/ui/progress" class="nav-link" data-key="t-progress">{{
                                            $t("t-progress")
                                        }}
                                    </Link>
                                </li>
                        ...
                        <BCol col lg="4">
                            <ul class="nav nav-sm flex-column">
                                ...
                                <li class="nav-item">
                                    <Link href="/ui/lists" class="nav-link" data-key="t-lists">{{
                                            $t("t-lists")
                                        }}
                                    </Link>
                                </li>
