...
const avatar = computed(function (){
    if(page.props.auth.avatar){
        return page.props.auth.avatar
    }


    return `https://ui-avatars.com/api/?name=${page.props.auth.first_name.substring(0,1)}+${page.props.auth.last_name.substring(0,1)}&color=7F9CF5&background=EBF4FF`;
});
            ...
            <div class="navbar-header">
                ...
                <div class="d-flex align-items-center">
                    <slot name="bottom-right-nav-bar-block">
                        ...
                        <BDropdown
                            variant="link"
                            class="ms-sm-3 header-item topbar-user bg-transparent"
...
<!--                                    <img v-if="$page.props.auth.avatar" :src="$page.props.auth.avatar" alt>-->
                                    ...
                                    <span v-else class="text-start ms-xl-2">
                                        ...
                                        <span class="d-none d-sm-block ms-1 fs-12 user-name-sub-text">
                                            {{ $page.props.auth?.role?.name }}
                                        </span>
                                    </span>
                                </span>
                            </template>
                            <h6 class="dropdown-header">Welcome {{ $page.props.auth.fullName }}!</h6>
