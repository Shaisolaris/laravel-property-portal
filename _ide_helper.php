...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function renameKey($keys, $oldKey, $newKey)
        {
                        return \Illuminate\Support\Arr::renameKey($keys, $oldKey, $newKey);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function renameKeys($keys, $oldKeys, $newKeys)
        {
                        return \Illuminate\Support\Arr::renameKeys($keys, $oldKeys, $newKeys);
        }
     ...
     */ 
         ...
         * @static 
         */ 
        public static function flash($type, $text)
        {
                        return \Illuminate\Http\RedirectResponse::flash($type, $text);
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Http\RedirectResponse::info($text);
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Http\RedirectResponse::success($text);
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Http\RedirectResponse::warning($text);
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Http\RedirectResponse::error($text);
        }
                    /**
         * 
         *
